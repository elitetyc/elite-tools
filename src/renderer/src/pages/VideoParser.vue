...
import { ChevronLeftCircleIcon, ChevronRightCircleIcon, PlayCircleIcon, RefreshIcon,ArrowRightIcon } from "tdesign-icons-vue-next";
...
<template>
  ...
  <t-card style="background: transparent;width: 100%; " :bordered="false">
    <t-loading :loading="isLoading">
      <webview
        ...
        @did-fail-load="MessagePlugin.error({ content: '加载失败' })"
      >
      </webview>
    </t-loading>
  </t-card>
